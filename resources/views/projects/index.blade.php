                        ...
                        <div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8 float-left">
                                <div class="wt-userlistingholder wt-haslayout">
                                        ...
                                        <div class="wt-userlistingcontent">
                                            ...
                                            <div class="wt-viewjobholder">
                                                <ul>
                                                    ...
                                                    <li><span><em><img src="/assets/images/flag/img-04.png" alt="img description"></em>England</span></li>
                                    ...
                                    <div class="wt-userlistinghold wt-featured wt-userlistingholdvtwo">
                                        <span class="wt-featuredtag wt-featuredtagcolor1"><img src="/assets/images/featured.png" alt="img description" data-tipso="Plus Member" class="template-content tipso_style"></span>
                                        <div class="wt-userlistingcontent">
                                            <div class="wt-contenthead">
                                                <div class="wt-title">
                                            ...
                                            <div class="wt-viewjobholder">
                                                <ul>
                                                    <li><span><i class="fa fa-dollar-sign wt-viewjobdollar"></i>Professional</span></li>
                                                    <li><span><em><img src="/assets/images/flag/img-02.png" alt="img description"></em>United States</span></li>
                                    ...
                                    <div class="wt-userlistinghold wt-userlistingholdvtwo">
                                        <div class="wt-userlistingcontent">
                                            <div class="wt-contenthead">
                                                <div class="wt-title">
                                                    <a href="usersingle.html"><i class="fa fa-check-circle"></i> Traprator House</a>
                                                    <h2>Form-Slider Plugin for Wordpress</h2>
                                                </div>
                                                <div class="wt-description">
                                                    <p>Nisi ut aliquip ex ea commodo consequat duis aute irure dolor in reprehenderit inati voluptate velit esse cillum dolore eutates fugiat nulla pariatur sunt in culpa asequi officia deserunt mollit anim id est laborum ut perspiciatis...</p>
                                                </div>
                                        ...
                                        <div class="wt-userlistingcontent">
                                            ...
                                            <div class="wt-viewjobholder">
                                                <ul>
                                                    ...
                                                    <li><span><em><img src="/assets/images/flag/img-03.png" alt="img description"></em>Canada</span></li>
                                                    <li><span><i class="far fa-folder wt-viewjobfolder"></i>Type: Per Fixed</span></li>
                                                    <li><span><i class="far fa-clock wt-viewjobclock"></i>Duration: 15 Days</span></li>
